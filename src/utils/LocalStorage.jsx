      ...
      "tasks": [
        {
          ...
          "task_description": "Prepare and submit the final report for the project.",
        ...
        },
        {
          ...
          "task_description": "Ensure all employee details are current and accurate.",
    ...
    },
    {
      ...
      "tasks": [
        ...
        },
        {
          ...
          "task_description": "Gather feedback from customers for service improvement.",
    ...
    },
    {
      ...
      "tasks": [
        ...
        },
        {
          ...
          "task_description": "Optimize vendor relationships and supply chain efficiency.",
      ...
      "tasks": [
        {
          ...
          "task_description": "Analyze financial data and generate a quarterly report.",
